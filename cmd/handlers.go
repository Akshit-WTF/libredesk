...
func initHandlers(g *fastglue.Fastglue, hub *ws.Hub) {
	...
	g.POST("/api/v1/conversations/{uuid}/whatsapp/reengagement", perm(handleSendWhatsAppReEngagement, "messages:write"))
	...
	// WhatsApp (Twilio) webhook – public, protected by Twilio signature validation.
	g.POST("/api/v1/inboxes/whatsapp/{uuid}/webhook", handleTwilioWhatsAppWebhook)
